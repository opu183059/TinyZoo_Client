const Review = () => {
  return (
    <div>
      <section className="my-8 md:w-10/12 mx-auto">
        <div className="container mx-auto flex flex-col items-center pb-6 mb-4 md:p-10 md:px-12">
          <h1 className="text-4xl font-semibold leadi text-center font-akaya text-amber-800">
        ...
        <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
          ...
          >
            ...
            <p className="font-bold text-amber-800">Leroy Jenkins</p>
          </div>
          <div
            data-aos="fade-left"
            data-aos-duration="1000"
          ...
          >
            ...
            <span className="w-12 h-1 my-2 rounded-lg dark:bg-blue-400"></span>
            <p className="font-bold text-amber-800">Jenny laurence</p>
          </div>
          <div
            data-aos="fade-right"
            data-aos-duration="1000"
          ...
          >
            <div className="relative text-center">
              ...
              <p className="px-6 py-1 text-lg italic">
                voluptatum quidem magnam velit excepturi nobis, reprehenderit
                ducimus incidunt quisquam quae veritatis, quos iure harum.
              </p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
            ...
            <span className="w-12 h-1 my-2 rounded-lg dark:bg-blue-400"></span>
            <p className="font-bold text-amber-800">Albert Json</p>
          </div>
          <div
            data-aos="fade-left"
            data-aos-duration="1000"
          ...
          >
            <div className="relative text-center">
              ...
              <p className="px-6 py-1 text-lg italic">
                Nulla quibusdam earum dolorem non error, explicabo praesentium,
                dolores beatae reiciendis at provident hic blanditiis et
                architecto debitis voluptatem quos repudiandae tempore impedit!
              </p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
            ...
            <span className="w-12 h-1 my-2 rounded-lg dark:bg-blue-400"></span>
            <p className="font-bold text-amber-800">Devid Khan</p>
          </div>
        </div>
      </section>
    </div>
